                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 p-sm-0 text-white">
                                            <p>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 p-sm-0 text-secondary">
                                            <p>
                                                April 24, 2024
                                            </p>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 mt-sm-2 p-sm-0">
                                            <p>
                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus quaerat architecto voluptatibus excepturi doloribus nulla? At delectus placeat sunt labore inventore. A tenetur molestiae laboriosam nam veniam rem, mollitia fuga eos deserunt, sed iure alias ullam. Aliquam est aperiam iusto laudantium consequatur, odio commodi, expedita ipsum illum eius impedit quod!
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row mb-sm-3">
